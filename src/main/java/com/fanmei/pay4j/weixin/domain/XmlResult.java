...
public class XmlResult implements Serializable {
    ...
    public static XmlResult of(@Nonnull String returnCode, @Nonnull String returnMsg){
        return new XmlResult(returnCode,returnMsg);
    }

    @JSONField(serialize = false)
    public boolean isOk() {
        return Constants.SUCCESS_UPPER.equalsIgnoreCase(returnCode);
    }

    @JSONField(serialize = false)
    public boolean isSuccess() {
        return isOk() && Constants.SUCCESS_UPPER.equalsIgnoreCase(resultCode);
    }
